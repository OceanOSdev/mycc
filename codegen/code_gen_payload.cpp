...
CodeGenPayload *CodeGenPayload::create_payload(
    std::string filename,
    std::vector<Binding::BoundGlobalDeclarationNode *> bound_declarations) {
...
CodeGenPayload *CodeGenPayload::create_payload(
    std::string in_filename, std::string out_filename,
    std::vector<Binding::BoundGlobalDeclarationNode *> bound_declarations) {
  std::vector<Binding::BoundGlobalDeclarationNode *> lowered_program =
      Binding::TreeRewriter::rewrite(bound_declarations);
  return new CodeGenPayload(in_filename, out_filename, lowered_program);
}

std::string CodeGenPayload::output_filename() const { return m_out_filename; }
...
CodeGenPayload::lowered_global_declarations() const {
