...
private:
    ...
    CodeGenPayload(std::string in_filename, std::string out_filename, std::vector<Binding::BoundGlobalDeclarationNode*> bound_declarations);
public:
    /**
     ...
     * @param bound_declarations The list of bound declaration nodes from the binder.
     */
    static CodeGenPayload* create_payload(std::string in_filename, std::string out_filename, std::vector<Binding::BoundGlobalDeclarationNode*> bound_declarations);
