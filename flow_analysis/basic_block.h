...
public:
    /**
     * @brief Constructs a new instance of a Basic Block in the Control Flow Diagram.
     */
    BasicBlock();
     ...
     */
    void add_all_statements(std::vector<Binding::BoundStatementNode*> statements);
     ...
     * 
     * @param incoming_block_branches The list of incoming basic block branch edges to add.
     */
    void add_all_incoming(std::vector<BasicBlockBranch*> incoming_block_branches);
     ...
     * 
     * @param outgoing_block_branches The list of outgoing basic block branch edges to add.
     */
    void add_all_outgoing(std::vector<BasicBlockBranch*> outgoing_block_branches);
