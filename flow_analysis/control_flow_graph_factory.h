...
private:
  std::unordered_map<Binding::BoundStatementNode *, BasicBlock *>
      m_block_from_statement_map;
  std::unordered_map<Binding::BoundLabel *, BasicBlock *>
      m_block_from_label_map;
   ...
   */
  void connect_blocks(BasicBlock *from, BasicBlock *to,
                      Binding::BoundExpressionNode *condition = nullptr);
   ...
   */
  void remove_block(std::vector<BasicBlock *> &block_list,
                    BasicBlock *block_to_remove);
