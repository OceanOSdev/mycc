...
PartialVariableDeclarationNode::PartialVariableDeclarationNode(
    SyntaxToken *token, std::string id, bool assign, bool arr, int arr_c,
    ExpressionNode *e)
    : SyntaxNode(token), ident(id), is_assign(assign), is_arr(arr),
      array_size(arr_c), expr(e) {}
 ...
 */
std::string PartialVariableDeclarationNode::identifier() const { return ident; }

/*
 * Whether or not this variable is being assigned
 * to at declaration.
 */
bool PartialVariableDeclarationNode::is_assigned() const { return is_assign; }

/*
 * Whether or not this variable is an array.
 */
bool PartialVariableDeclarationNode::is_array() const { return is_arr; }
 ...
 */
int PartialVariableDeclarationNode::array_length() const { return array_size; }
