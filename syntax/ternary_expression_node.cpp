...
TernaryExpressionNode::TernaryExpressionNode(SyntaxToken *token,
                                             ExpressionNode *expr,
                                             ExpressionNode *t_expr,
                                             ExpressionNode *f_expr)
    : ExpressionNode(token), mux_expr(expr), true_expr(t_expr),
      false_expr(f_expr) {}
