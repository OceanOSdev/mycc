...
ForStatementNode::ForStatementNode(SyntaxToken *token, ExpressionNode *ini,
                                   ExpressionNode *condition,
                                   ExpressionNode *inc, StatementNode *body)
    : StatementNode(token), init_expr(ini), cond_expr(condition), inc_expr(inc),
      body_stmt(body) {}
 ...
 */
ExpressionNode *ForStatementNode::third_expression() const { return inc_expr; }

/*
 * The body statement that runs every loop.
 */
StatementNode *ForStatementNode::body_statement() const { return body_stmt; }
...
SyntaxKind ForStatementNode::kind() const { return SyntaxKind::ForStatement; }
