...
PartTwoSyntaxPrinter::PartTwoSyntaxPrinter(Syntax::ProgramNode *prgm,
...
void PartTwoSyntaxPrinter::visit_global_declaration_node(
    Syntax::GlobalDeclarationNode *g) {
  if (auto gvgd =
...
void PartTwoSyntaxPrinter::visit_tranlation_unit_node(
    Syntax::TranslationUnitNode *t) {
...
std::vector<std::string> PartTwoSyntaxPrinter::var_to_string(
    std::vector<Syntax::VariableGroupDeclarationNode *> variables) {
...
std::vector<std::string> PartTwoSyntaxPrinter::param_to_string(
    std::vector<Syntax::FormalParameterNode *> params) {
...
void PartTwoSyntaxPrinter::log_func_prototype(
    Syntax::FunctionPrototypeNode *p) {
...
void PartTwoSyntaxPrinter::log_func_definition(
    Syntax::FunctionDefinitionNode *d) {
...
void PartTwoSyntaxPrinter::log_glob_structs(PartTwoSymbolTable tbl) {
  for (auto glob_struct : tbl.glob_structs) {
    ...
    std::vector<std::string> member_names =
        var_to_string(glob_struct->struct_members());
