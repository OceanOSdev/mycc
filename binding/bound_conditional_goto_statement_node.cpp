...
BoundConditionalGotoStatementNode::BoundConditionalGotoStatementNode(
    BoundLabel *label, BoundExpressionNode *condition, bool jump_if_true)
    : m_label(label), m_condition(condition), m_jump_if_true(jump_if_true) {}

BoundLabel *BoundConditionalGotoStatementNode::label() const { return m_label; }
