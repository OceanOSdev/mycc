...
Factory::assignment(Symbols::VariableSymbol *variable,
                    BoundExpressionNode *expression) {
  return new BoundAssignmentExpressionNode(
      BoundAssignmentOpKind::ASSIGN, Factory::var_ref(variable), expression);
}
...
BoundAssignmentExpressionNode::BoundAssignmentExpressionNode(
    ...
    BoundExpressionNode *expression)
    : m_assignment_op_kind(assignment_op_kind), m_variable_reference(variable),
      m_expression(expression) {}

BoundAssignmentOpKind
BoundAssignmentExpressionNode::assignment_op_kind() const {
  return m_assignment_op_kind;
}

BoundVariableReferenceExpressionNode *
BoundAssignmentExpressionNode::variable_reference() const {
