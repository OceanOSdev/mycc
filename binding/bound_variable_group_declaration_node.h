...
public:
    BoundVariableDeclarationNode(Symbols::VariableSymbol* variable_symbol, BoundExpressionNode* initializer);
...
public:
    BoundVariableGroupDeclarationNode(std::vector<BoundVariableDeclarationNode*> variable_declarations);
