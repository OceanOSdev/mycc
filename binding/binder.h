...
private:
  ...
  Symbols::FunctionSymbol
      *m_current_function; // set when binding methods in function body
  std::stack<Symbols::StructSymbol *>
      m_struct_scope; // for when binding name and index expressions of
                      // submembers, will be empty otherwise.
  std::stack<std::tuple<BoundLabel *, BoundLabel *>>
      m_loop_stack; // for binding break and continue statements, we check if
                    // they are in a loop first
  ...
  /* global bindings */
  Symbols::FunctionSymbol *
  bind_function_declaration(Syntax::FunctionDeclarationNode *declaration);
  void bind_function_prototype(Syntax::FunctionPrototypeNode *prototype);
  BoundFunctionDefinitionNode *
  bind_function_definition(Syntax::FunctionDefinitionNode *function_definition);
  ...
  BoundStatementNode *bind_expression_statement(
      Syntax::ExpressionStatementNode *expression_statement);
  BoundStatementNode *
  bind_block_statement(Syntax::BlockStatementNode *block_statement,
                       bool create_new_scope = true);
  BoundStatementNode *bind_variable_group_declaration(
      Syntax::VariableGroupDeclarationNode *variable_group,
      bool is_global_scope = false);
  BoundStatementNode *
  bind_return_statement(Syntax::ReturnStatementNode *return_statement);
  BoundStatementNode *
  bind_struct_declaration(Syntax::StructDeclarationNode *struct_declaration);
  BoundStatementNode *
  bind_break_statement(Syntax::BreakStatementNode *break_statement);
  BoundStatementNode *
  bind_continue_statement(Syntax::ContinueStatementNode *continue_statement);
  BoundStatementNode *
  bind_do_while_statement(Syntax::DoWhileStatementNode *do_while_statement);
  BoundStatementNode *
  bind_for_statement(Syntax::ForStatementNode *for_statement);
  BoundStatementNode *bind_if_statement(Syntax::IfStatementNode *if_statement);
  BoundStatementNode *
  bind_while_statement(Syntax::WhileStatementNode *while_statement);
  BoundStatementNode *bind_loop_body(Syntax::StatementNode *body,
                                     BoundLabel *&break_label,
                                     BoundLabel *&continue_label);

  /* expression bindings */
  BoundExpressionNode *bind_error_expression();
  BoundExpressionNode *bind_expression(Syntax::ExpressionNode *expression,
                                       bool canBeVoid = false);
  BoundExpressionNode *
  bind_expression_internal(Syntax::ExpressionNode *expression);
  BoundExpressionNode *bind_literal_val_expression(
      Syntax::LiteralValExpressionNode *literal_expression);
  BoundExpressionNode *
  bind_name_expression(Syntax::NameExpressionNode *name_expression);
  BoundExpressionNode *
  bind_member_expression(Syntax::MemberExpressionNode *member_expression);
  BoundExpressionNode *
  bind_index_expression(Syntax::IndexExpressionNode *index_expression);
  BoundExpressionNode *
  bind_cast_expression(Syntax::CastExpressionNode *cast_expression);
  BoundExpressionNode *
  bind_binary_expression(Syntax::BinaryExpressionNode *binary_expression);
  BoundExpressionNode *
  bind_unary_expression(Syntax::UnaryExpressionNode *unary_expression);
  BoundExpressionNode *bind_assignment_expression(
      Syntax::AssignmentExpressionNode *assignment_expression);
  BoundExpressionNode *
  bind_call_expression(Syntax::CallExpressionNode *call_expression);
  BoundExpressionNode *
  bind_ternary_expression(Syntax::TernaryExpressionNode *ternary_expression);
  BoundExpressionNode *bind_increment_expression(
      Syntax::IncrementExpressionNode *increment_expression);
  BoundExpressionNode *bind_decrement_expression(
