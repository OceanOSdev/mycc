...
BoundIfStatementNode::BoundIfStatementNode(BoundExpressionNode* condition, BoundStatementNode* then_stmt, BoundStatementNode* else_stmt) :
    m_condition(condition), m_then_statement(then_stmt), m_else_statement(else_stmt) {}
