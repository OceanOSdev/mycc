...
BoundFunctionDefinitionNode::BoundFunctionDefinitionNode(
...
Factory::function_def(Symbols::FunctionSymbol *symbol,
...
BoundFunctionDefinitionNode *
Factory::function_init(BoundBlockStatementNode *block) {
  return function_def(Symbols::Factory::init_function(), block);
}

BoundFunctionDefinitionNode *
Factory::function_clinit(BoundBlockStatementNode *block) {
