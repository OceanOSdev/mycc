...
BoundVariableDeclarationNode::BoundVariableDeclarationNode(Symbols::VariableSymbol* variable_symbol, BoundExpressionNode* initializer) :
...
BoundVariableGroupDeclarationNode::BoundVariableGroupDeclarationNode(std::vector<BoundVariableDeclarationNode*> variable_declarations) :
    m_variable_declarations(variable_declarations) {}

std::vector<BoundVariableDeclarationNode*> BoundVariableGroupDeclarationNode::variable_declarations() const {
