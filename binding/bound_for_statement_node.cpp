...
BoundForStatementNode::BoundForStatementNode(BoundExpressionNode *init,
                                             ...
                                             BoundLabel *cont_lbl)
    : m_init_expression(init), m_cond_expression(cond),
      m_third_expression(third), m_body_statement(body),
      m_break_label(break_lbl), m_continue_label(cont_lbl) {}
...
BoundLabel *BoundForStatementNode::break_label() const { return m_break_label; }
