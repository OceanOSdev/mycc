...
BoundScope *BoundScope::parent() const { return m_parent; }
...
bool BoundScope::try_declare_variable(
    Symbols::VariableSymbol *variable_symbol) {
...
bool BoundScope::try_declare_function(
  ...
  if (m_function_symbols.contains(function_symbol->name())) {
    ...
    auto orig_func = dynamic_cast<Symbols::FunctionSymbol *>(
        m_function_symbols[function_symbol->name()]);
...
bool BoundScope::try_look_up_variable(std::string identifier,
...
bool BoundScope::try_look_up_struct(std::string identifier,
...
bool BoundScope::try_look_up_function(std::string identifier,
...
bool BoundScope::try_look_up_type(std::string identifier,
...
bool BoundScope::is_root() const { return (m_parent == nullptr); }
