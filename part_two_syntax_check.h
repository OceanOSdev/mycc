...
using func_wrapper = std::variant<Syntax::FunctionPrototypeNode *,
                                  Syntax::FunctionDefinitionNode *>;
...
private:
  ...
  var_to_string(std::vector<Syntax::VariableGroupDeclarationNode *> variables);
  std::vector<std::string>
  param_to_string(std::vector<Syntax::FormalParameterNode *> params);
