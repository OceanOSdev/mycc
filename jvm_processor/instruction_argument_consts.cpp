...
ITupleConstInstructionArgument::ITupleConstInstructionArgument(int val_one, int val_two) :
    m_ival_one(val_one),
    m_ival_two(val_two) {}
...
int ITupleConstInstructionArgument::first_value() const {
    return m_ival_one;
}

int ITupleConstInstructionArgument::second_value() const {
    return m_ival_two;
}
...
CConstInstructionArgument::CConstInstructionArgument(char val) :
    m_cval(val) {}

char CConstInstructionArgument::value() const {
    return m_cval;
}
...
int IConstInstructionArgument::value() const {
    return m_ival;
}
...
float FConstInstructionArgument::value() const {
    return m_fval;
}
...
std::string SConstInstructionArgument::value() const {
    return m_sval;
}
