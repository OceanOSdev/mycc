...
BuilderState::BuilderState()
    : m_max_stack_size(0), m_current_stack_size(0), m_op_codes_emitted(0) {}

int BuilderState::max_stack_size() const { return m_max_stack_size; }

int BuilderState::current_stack_size() const { return m_current_stack_size; }

int BuilderState::op_codes_emitted() const { return m_op_codes_emitted; }
