...
void print_function_declaration_node(Syntax::FunctionDeclarationNode *f,
                                     std::string indent) {
  // std::cout << indent;
  std::cout << "[Func Decl]: ";
  if (f->is_const())
  ...
  if (!parameters.empty()) {
    ...
    for (param_iter = parameters.begin(); param_iter != parameters.end();
         param_iter++) {
...
void print_expression_node(Syntax::ExpressionNode *e, std::string indent) {
  if (auto ce = dynamic_cast<Syntax::CastExpressionNode *>(e)) {
    ...
    if (ie->is_post())
      std::cout << "[Post-Incr Expr]: ";
    else
      std::cout << "[Pre-Incr Expr]: ";
    std::cout << std::endl;
    std::cout << indent + "└──";
    ...
    if (de->is_post())
      std::cout << "[Post-Decr Expr]: ";
    else
      std::cout << "[Pre-Decr Expr]: ";
    std::cout << std::endl;
    std::cout << indent + "└──";
    ...
    std::cout << "[Index Expr]:";
    std::cout << std::endl
              << indent + "├──" << "[ident]: " << ine->name() << std::endl;
    std::cout << indent + "└──";
    ...
    std::cout << std::endl
              << indent + "├──" << "[OP]: "
              << syntax_token_type_as_string(ue->syntax_token_type());
    std::cout << std::endl;
    std::cout << indent + "└──";
    ...
    std::cout << indent + "├──" << "[OP]: "
              << syntax_token_type_as_string(be->syntax_token_type());
    std::cout << std::endl;
    std::cout << indent + "└──";
...
void print_block_statement_node(Syntax::BlockStatementNode *node,
                                std::string indent) {
...
void print_break_statement_node() { std::cout << "[BREAK]" << std::endl; }

void print_continue_statement_node() { std::cout << "[CONTINUE]" << std::endl; }

void print_do_while_statement_node(Syntax::DoWhileStatementNode *node,
                                   std::string indent) {
...
void print_expression_statement_node(Syntax::ExpressionStatementNode *node,
                                     std::string indent) {
  print_node(node->expression(), indent);
}

void print_for_statement_node(
    __attribute__((unused)) Syntax::ForStatementNode *node,
    __attribute__((unused)) std::string indent) {}

void print_if_statement_node(Syntax::IfStatementNode *node,
                             std::string indent) {
...
void print_return_statement_node(Syntax::ReturnStatementNode *node,
                                 std::string indent) {
...
void print_while_statement_node(Syntax::WhileStatementNode *node,
                                std::string indent) {
...
void print_global_declaration_node(Syntax::GlobalDeclarationNode *g,
                                   std::string indent) {
  if (auto gvgd =
          dynamic_cast<Syntax::GlobalVariableGroupDeclarationNode *>(g)) {
    print_node(gvgd->variable_group(), indent);

  } else if (auto gsd =
                 dynamic_cast<Syntax::GlobalStructDeclarationNode *>(g)) {
...
void print_local_declaration_node(Syntax::LocalDeclarationNode *ld,
                                  std::string indent) {
...
void print_partial_variable_declaration_node(
    Syntax::PartialVariableDeclarationNode *p, std::string indent) {
...
void print_tranlation_unit_node(Syntax::TranslationUnitNode *t,
                                std::string indent) {
...
void print_nodes(Syntax::SyntaxNode *n) { print_node(n, ""); }
