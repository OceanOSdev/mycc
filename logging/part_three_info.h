...
public:
  ...
  bool ignore =
      false; // For when the binder binds conditional expressions in loop
             // statements or anything in funciton prototypes, set this to true

  void add_var_info(std::string _type, std::string _name, bool init,
                    bool global);
